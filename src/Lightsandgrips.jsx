...
import Lightsandgripshero from './components/Lightsandgrips/Lightsandgripshero'
import Lightsandgripsweprovidetext from './components/Lightsandgrips/Lightsandgripsweprovidetext'
import Lightsandgripsweprovide from './components/Lightsandgrips/Lightsandgripsweprovide'
...
const Lightsandgrips = () => {
  ...
  return (
    <div className="bg-black">
      ...
      <Lightsandgripsweprovidetext />
      <Lightsandgripsweprovide
        handleOrderPopup={handleOrderPopup}
        img={Banner1}
      ...
      />
      <OrderPopup orderPopup={showOrderPopup} setOrderPopup={setShowOrderPopup} type={"Lights and Grips"} />
      <Exploreourspaces />
      <Callusbanner />
    </div>
  )
