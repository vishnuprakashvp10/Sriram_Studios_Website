...
import Renovationservicesweprovidetext from "./Renovationservicesweprovidetext";

const Renovationservicesweprovide = ({ reverse, img, title, description2, description, handleOrderPopup }) => {
  return (
...
export default Renovationservicesweprovide