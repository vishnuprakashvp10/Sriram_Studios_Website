...
const Exploreourspacescard = [
  ...
  },
  {
    ...
    text: "Multiple angles and shots are captured at once, providing a more complete view of the action.",
  },
];


const Exploreourspaces = () => {
                  ...
                  <div className={`flex flex-col transition-all shadow-md hover:scale-105 gap-4 pb-2 mx-4 bg-secondary relative`}>
                    ...
                    <div className="flex flex-col items-center gap-4">
                      <div className="space-y-3">
                        ...
                        <p className="text-xs text-center text-white p-2">{data.text}</p>
                      </div>
...
export default Exploreourspaces;
