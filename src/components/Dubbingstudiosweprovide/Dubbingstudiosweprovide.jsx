...
const Dubbingstudiosweprovide = ({ reverse, img, title, description, handleOrderPopup }) => {
  return (
    <section>
      <main className="text-white">
        <section className="container flex flex-col items-center justify-center py-14  md:h-[500px] ">
...
export default Dubbingstudiosweprovide;