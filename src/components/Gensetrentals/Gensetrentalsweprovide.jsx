...
import Renovationservicesweprovidetext from "./Gensetrentalsweprovidetext";

const Gensetrentalsweprovide = ({ reverse, img, title, description2, description, handleOrderPopup }) => {
  return (
...
export default Gensetrentalsweprovide