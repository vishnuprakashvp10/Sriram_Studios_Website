...
const Turfconstructionweprovide = ({ reverse, img, title, description, description2, handleOrderPopup }) => {
  return (
    <section>
      <main className="text-white">
        <section className="container flex flex-col items-center justify-center py-10 md:h-[500px] mb-10 mt-20">   
...
export default Turfconstructionweprovide;
