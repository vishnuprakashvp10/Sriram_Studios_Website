...
const LensfiltersweprovideData = [
  {
    id: 1,
    img: Img1,
    name: "Haze Filters",
...
const Lensfiltersweprovide = ({handleOrderPopup}) => {
    ...
    <div className="py-14 mb-10">
      <div className="container">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-20 md:gap-5 place-items-center">
          {LensfiltersweprovideData.map((service, index) => (
            <div
              key={service.id}
...
export default Lensfiltersweprovide;
