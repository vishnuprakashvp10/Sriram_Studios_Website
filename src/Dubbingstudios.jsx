...
import Dubbingstudioshero from './components/Dubbingstudioshero/Dubbingstudioshero'
import Dubbingstudiosweprovidetext from './components/Dubbingstudiosweprovide/Dubbingstudiosweprovidetext'
import Dubbingstudiosweprovide from './components/Dubbingstudiosweprovide/Dubbingstudiosweprovide'
...
const Dubbingstudios = () => {
  ...
  return (
    <div className="bg-black">
      ...
      <Dubbingstudiosweprovidetext />
      <Dubbingstudiosweprovide
        handleOrderPopup={handleOrderPopup}
        img={Banner1}
      ...
      />
      <OrderPopup orderPopup={showOrderPopup} setOrderPopup={setShowOrderPopup} type={"Dubbing Studios"} />
      <Exploreourspaces />
      <Callusbanner />
    </div>
  )
