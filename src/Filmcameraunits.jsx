...
import Filmcameraunitshero from './components/Filmcameraunitshero/Filmcameraunitshero'
import Filmcameraunitsweprovidetext from './components/Filmcameraunitsweprovide/Filmcameraunitsweprovidetext'
import Filmcameraunitsweprovide from './components/Filmcameraunitsweprovide/Filmcameraunitsweprovide'
 ...
 const handleOrderPopup = () => {
  ...
  return (
    <div className="bg-black">
      ...
      <Filmcameraunitsweprovidetext />
      <Filmcameraunitsweprovide
        handleOrderPopup={handleOrderPopup}
        img={Banner1}
...
/>
      <OrderPopup orderPopup={showOrderPopup} setOrderPopup={setShowOrderPopup} type={"Film Camera Units"} />
      <Exploreourspaces />
      <Callusbanner />
...
export default Filmcameraunits
