...
import Gensetrentalshero from './components/Gensetrentals/Gensetrentalshero'
import Gensetrentalsweprovidetext from './components/Gensetrentals/Gensetrentalsweprovidetext'
import Gensetrentalsweprovide from './components/Gensetrentals/Gensetrentalsweprovide'
...
const Gensetrentals = () => {
  ...
  return (
    <div className="bg-black">
      ...
      <Gensetrentalsweprovidetext />
      <Gensetrentalsweprovide
        handleOrderPopup={handleOrderPopup}
        img={Banner1}
      ...
      />
      <OrderPopup orderPopup={showOrderPopup} setOrderPopup={setShowOrderPopup} type={"Genset Rentals"} />
      <Exploreourspaces />
      <Callusbanner />
    </div>
  )
